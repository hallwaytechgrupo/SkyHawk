...
| TC-0003    | Desenvolvimento da lógica para tratamento dos dados da stack, e exibição em cards           | Dados disponíveis e estrutura de séries pronta                                      | Comparação funcional entre séries de diferentes satélites                          |
