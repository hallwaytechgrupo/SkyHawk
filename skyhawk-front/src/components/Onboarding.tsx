...
const steps = [
  {
    ...
    description:
      "Clique em qualquer lugar do mapa para definir a localização de interesse. O sistema irá carregar dados disponíveis para esse ponto.",
  },
  {
    title: "Inserir Coordenadas (opcional)",
    description:
      "Você pode inserir latitude e longitude manualmente na barra superior se preferir precisão numérica.",
  },
  {
    title: "Visualizar Séries Temporais",
    description:
      "Após selecionar o ponto, abra a análise para ver séries temporais (NDVI, por exemplo) e indicadores principais.",
  },
  {
    title: "Filtrar e Exportar",
    description:
      "Use os filtros disponíveis para escolher satélite, variável e período. Você pode exportar os metadados quando necessário.",
  },
];
...
const cardStyles: React.CSSProperties = {
  ...
  padding: "20px",
  boxShadow:
    "0 12px 40px rgba(2,6,23,0.6), inset 0 1px 0 rgba(255,255,255,0.02)",
};
...
const Onboarding: React.FC = () => {
  ...
  const close = () => {
    if (dontShow) {
      try {
        localStorage.setItem("skyhawk:onboardingSeen", "true");
      } catch {
      ...
      <div style={cardStyles}>
        ...
        >
          <div>
            ...
            <p style={{ margin: "6px 0 0 0", color: "rgba(255,255,255,0.72)" }}>
              Um breve passo a passo para começar a usar o sistema.
            </p>
          </div>
            ...
            {steps.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    i === index
                      ? "linear-gradient(135deg,#007cbf,#005a8b)"
